...
public abstract class ASTVisitor
{
    ...
    public abstract void visit(BooleanDeclarationNode node);
    ...
    public abstract void visit(FunctionDeclarationNode node);
    ...
    public abstract void visit(NumberDeclarationNode node);
    ...
    public abstract void visit(StrategyDeclarationNode node);
    public abstract void visit(SubtractionNode node);
    public abstract void visit(TextDeclarationNode node);
